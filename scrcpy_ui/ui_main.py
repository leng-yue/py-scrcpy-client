...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_info_title.setText(QCoreApplication.translate("MainWindow", u"Info: ", None))
        ...
        ___qtablewidgetitem2.setText(QCoreApplication.translate("MainWindow", u"Run Mode", None));
        ___qtablewidgetitem3 = self.table_devices.horizontalHeaderItem(4)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("MainWindow", u"Operate", None));
        ___qtablewidgetitem4 = self.table_devices.horizontalHeaderItem(5)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("MainWindow", u"Others", None));
