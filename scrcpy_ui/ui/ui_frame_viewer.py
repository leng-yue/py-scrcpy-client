...
from PySide6.QtWidgets import (QGraphicsView, QGridLayout, QGroupBox,
...
class Ui_FrameViewer(object):
    ...
    def setupUi(self, Form):
        ...
        self.label_picture_resolution.setObjectName(u"label_picture_resolution")
        ...
        self.label_picture_zoom.setObjectName(u"label_picture_zoom")
        ...
        self.label_region_point1.setObjectName(u"label_region_point1")
        ...
        self.label_region_point2.setObjectName(u"label_region_point2")
        ...
        self.label_region_size.setObjectName(u"label_region_size")
        ...
        self.button_save_region.setObjectName(u"button_save_region")
        ...
        self.button_cancel_region.setObjectName(u"button_cancel_region")
    ...
    def retranslateUi(self, Form):
        ...
        self.groupBox_2.setTitle(QCoreApplication.translate("Form", u"Info", None))
        self.label_7.setText(QCoreApplication.translate("Form", u"\u56fe\u7247-\u5206\u8fa8\u7387", None))
        self.label_picture_resolution.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.label.setText(QCoreApplication.translate("Form", u"\u56fe\u7247-\u7f29\u653e", None))
        self.label_picture_zoom.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.label_3.setText(QCoreApplication.translate("Form", u"\u9009\u533a-\u5de6\u4e0a\u89d2\u70b9", None))
        self.label_region_point1.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.label_5.setText(QCoreApplication.translate("Form", u"\u9009\u533a-\u53f3\u4e0b\u70b9", None))
        self.label_region_point2.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.label_9.setText(QCoreApplication.translate("Form", u"\u9009\u533a-\u5927\u5c0f", None))
        self.label_region_size.setText(QCoreApplication.translate("Form", u"TextLabel", None))
        self.groupBox_3.setTitle(QCoreApplication.translate("Form", u"Picture", None))
        self.groupBox.setTitle(QCoreApplication.translate("Form", u"control", None))
        self.button_take_region.setText(
            QCoreApplication.translate("Form", u"\u5f00\u59cb\u9009\u62e9\u9009\u533a", None))
        self.button_save_region.setText(QCoreApplication.translate("Form", u"\u4fdd\u5b58\u9009\u533a", None))
        self.button_cancel_region.setText(QCoreApplication.translate("Form", u"\u53d6\u6d88\u9009\u533a", None))
    # retranslateUi
