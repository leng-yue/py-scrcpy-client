...
class Ui_RegionSaveDialog(object):
    def setupUi(self, Dialog):
        ...
        sizePolicy2.setHeightForWidth(self.image_display.sizePolicy().hasHeightForWidth())
        ...
        self.line_edit_region_name.setObjectName(u"line_edit_region_name")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.groupBox_2.setTitle(QCoreApplication.translate("Dialog", u"Infomation", None))
        self.label_2.setText(QCoreApplication.translate("Dialog", u"\u6e90\u56fe\u7247\u5206\u8fa8\u7387", None))
        self.label_resolution.setText(QCoreApplication.translate("Dialog", u"TextLabel", None))
        self.label_4.setText(QCoreApplication.translate("Dialog", u"\u533a\u57df\u5de6\u4e0a\u89d2\u5750\u6807", None))
        self.label_point1.setText(QCoreApplication.translate("Dialog", u"TextLabel", None))
        self.label_6.setText(QCoreApplication.translate("Dialog", u"\u533a\u57df\u53f3\u4e0b\u89d2\u5750\u6807", None))
        self.label_point2.setText(QCoreApplication.translate("Dialog", u"TextLabel", None))
        self.label_8.setText(QCoreApplication.translate("Dialog", u"\u533a\u57df\u5927\u5c0f", None))
        self.label_region_size.setText(QCoreApplication.translate("Dialog", u"TextLabel", None))
        self.groupBox.setTitle(QCoreApplication.translate("Dialog", u"Image", None))
        self.image_display.setText(QCoreApplication.translate("Dialog", u"PIXMAP", None))
        self.groupBox_3.setTitle(QCoreApplication.translate("Dialog", u"Region-Entry-Name", None))
        self.label_10.setText(QCoreApplication.translate("Dialog", u"\u952e\u5165\u533a\u57df\u6807\u8bc6:", None))
    # retranslateUi
